...
var RateService = (function () {
  function RateService(rateRepository, infoRepository) {
  ...
  RateService.prototype.rate = function (rate) {
    return __awaiter(this, void 0, void 0, function () {
      var info, res, exist, res, history, histories, count;
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            info = _a.sent();
            if (!!info) return [3, 3];
            return [4, this.rateRepository.create(rate, true)];
          case 2:
            res = _a.sent();
            return [2, res];
          case 3: return [4, this.rateRepository.load(rate.id, rate.author)];
          case 4:
            exist = _a.sent();
            if (!!exist) return [3, 6];
            return [4, this.rateRepository.create(rate)];
          case 5:
            res = _a.sent();
            return [2, res];
          case 6:
            ...
            return [4, this.rateRepository.update(rate, exist.rate)];
          case 7:
            count = _a.sent();
            return [2, count];
        }
...
var RatesService = (function () {
  function RatesService(rateRepository, infoRepository) {
    this.rateRepository = rateRepository;
    this.infoRepository = infoRepository;
    this.rate = this.rate.bind(this);
  }
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 5:
            ...
            return [2, res];
          case 6:
            history = { review: exist.review, rates: exist.rates, time: exist.time };
            if (exist.histories && exist.histories.length > 0) {
              histories = exist.histories;
              histories.push(history);
              rate.histories = histories;
