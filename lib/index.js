...
var SqlRateRepository = (function () {
  ...
  SqlRateRepository.prototype.create = function (rate, tx) {
    ...
    if (stmt.query) {
      ...
      var db = tx ? tx : this.db;
      var query = this.insertOrUpdateInfo(rateNum);
  ...
  SqlRateRepository.prototype.insertOrUpdateInfo = function (r) {
    var ps = [];
    var rateCols = [];
...
var Rater = (function () {
  function Rater(db, rateRepository, usefulRepository) {
    this.db = db;
  ...
  Rater.prototype.rate = function (rateReq) {
    return __awaiter(this, void 0, void 0, function () {
      var rate, tx, exist, res, history, histories, oldRate, count, err_1;
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 2:
            _a.trys.push([2, 9, , 11]);
            return [4, this.rateRepository.load(rateReq.id, rateReq.author, tx)];
          case 3:
            exist = _a.sent();
            if (!!exist) return [3, 6];
            return [4, this.rateRepository.create(rate, tx)];
          case 4:
            res = _a.sent();
            return [4, tx.commit()];
          case 5:
